...
class PongEnvironment:
    ...
    def get_state(self):
        self.render(surface_override=self.offscreen_surface)
        surface = pygame.surfarray.array3d(self.offscreen_surface)
    ...
    def render(self, surface_override=None):
        surface = surface_override if surface_override else self.screen
        surface.fill((0, 0, 0))
        ...
        surface.blit(agent_text, (self.width - 22, 1))
        surface.blit(opponent_text, (15, 1))
